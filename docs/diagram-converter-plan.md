...
> Контекст: vuePlantUML — форматы `plantuml`, `mermaid`, `graphml`  
...
### 2.5 Metadata в SVG (экспорт vuePlantUML)
...
```xml
<metadata id="vueplantuml-ir" data-version="1" data-encoding="gzip-base64">
  ...
</metadata>
```
