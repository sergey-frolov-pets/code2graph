...
export const llmMessages: LocaleMessages = {
  ...
  "llm.wizard.languageAiHint": "AI supports PlantUML and Mermaid. GraphML is manual-only (view scaffold).",
  "llm.wizard.languageGraphmlHint": "GraphML opens in view-only mode; the editor cannot edit GraphML source.",
