...
export const settingsMessages: LocaleMessages = {
  ...
  "settings.llmFreeHint": "Ключ не нужен — запросы идут через сервер приложения. Укажите адрес сервера библиотеки (например http://localhost:3001).",
  "settings.llmNoProxyWarning": "Сервер LLM недоступен: укажите адрес сервера библиотеки в настройках или выберите BYOK-провайдер со своим ключом.",
