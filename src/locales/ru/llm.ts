...
export const llmMessages: LocaleMessages = {
  ...
  "llm.wizard.languageAiHint": "ИИ поддерживает PlantUML и Mermaid. GraphML — только вручную (шаблон для просмотра).",
  "llm.wizard.languageGraphmlHint": "GraphML открывается в режиме просмотра; редактирование в редакторе недоступно.",
